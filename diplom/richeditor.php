	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<span class="achtung">Текст считается готовым, когда в результатах проверки все вхождения подсвечиваются зеленым и синим.</span>
			</div>
...
<div class="container-fluid content">
	<div class="row">
		...
		<!-- поле с тз из бд -->
		<div class="col-lg-3">  
			<textarea name="vhod" form="one" type="text" class="area" placeholder="Результат" readonly><?php if(isset($_GET['event'])) {$tz = showOneTz($_GET['event']);} ?></textarea>
			</br>
	...
	<div class="row">
		<div class="col-lg-12" style="margin-top:20px;">
			...
			<div class="notebook">
				...
				<label class="label label-info" for="notebook1_1">Высшее образование</label>
				<input type="radio" name="notebook1" id="notebook1_2">
				<label class="label label-info" for="notebook1_2">Города</label>
				<input type="radio" name="notebook1" id="notebook1_3">
				<label class="label label-info" for="notebook1_3">Начальное образование</label>
				<input type="radio" name="notebook1" id="notebook1_4">
				<label class="label label-info" for="notebook1_4">Последипломное образование</label>
				<input type="radio" name="notebook1" id="notebook1_5">
				<label class="label label-info" for="notebook1_5">Профессии</label>
				<input type="radio" name="notebook1" id="notebook1_6">
				<label class="label label-info" for="notebook1_6">Справки и свидетельства</label>
				<input type="radio" name="notebook1" id="notebook1_7">
				<label class="label label-info" for="notebook1_7">Статьи</label>
				<div>
